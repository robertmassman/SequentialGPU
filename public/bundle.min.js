...
};var performanceTracker$1=/*#__PURE__*/Object.freeze({__proto__:null,PerformanceTracker:PerformanceTracker,getPerformanceTracker:getPerformanceTracker});/**
...
class RenderQueue {
    constructor() {
        this.config = getBuildConfig();
        this.performanceTracker = false ? getPerformanceTracker() : null;
    ...
    queue(operation, priority = 'normal', metadata = {}) {
        ...
        if (!true && this.performanceTracker) {
    ...
    getNextOperation() {
        ...
        if (this.pendingOperations.size === 1 || (!this.hasHighPriorityOps && true)) {
            const [id, wrapper] = this.pendingOperations.entries().next().value;
            return { id, wrapper };
        }
...
const createNoOpPerformanceTracker = () => new Proxy({}, { 
        get: () => () => {} 
    })
...
};var debugLogger_enhanced=/*#__PURE__*/Object.freeze({__proto__:null,DebugLogger:DebugLogger,debug:debug,getDebugLogger:getDebugLogger});export{RenderQueue,SequentialGPU,WebGpuRenderer,buildConfig,SequentialGPU as default,loadDebugModules};